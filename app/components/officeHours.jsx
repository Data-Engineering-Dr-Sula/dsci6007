      ...
      <div className="max-w-5xl mx-auto text-left">
        ...
        <div className="mb-8">
          ...
          <Table className="w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <a
                    href="https://unewhaven.zoom.us/j/9927253081"
          ...
          <p className="mt-4 text-gray-700">
            ...
            <a
              href="mailto:asula@newhaven.edu"
              className="text-blue-500 hover:underline"
            >
              asula@newhaven.edu
            </a>
        ...
        <div>
          <h3 className="text-xl font-semibold text-blue-600 mb-2">
            Teaching Assistant: Akash Thakkar
          </h3>
          <Table className="w-full bg-white shadow-md rounded-lg overflow-hidden">
            <TableHeader>
              <TableRow>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <a
                    href="https://unewhaven.zoom.us/j/zoomlink"
                    className="text-blue-500 hover:underline"
                  >
                    Zoom Link
                  </a>
          ...
          <p className="mt-4 text-gray-700">
            For appointments, contact{" "}
            <a
              href="mailto:athak13@unh.newhaven.edu"
              className="text-blue-500 hover:underline"
            >
              athak13@unh.newhaven.edu
            </a>
            . <br />
