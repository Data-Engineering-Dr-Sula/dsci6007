...
const contents = [
    ...
    },
    {
        ...
        material: ["Students will work on real-world data engineering projects and case studies"]
    },
        ...
        <section id="schedule" className="px-4 py-8 bg-blue-100">
            <div className="max-w-5xl mx-auto text-left">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                    Class slides (and instructor’s notes if given) do not replace class. If they are provided
                    it is with the intention of freeing up your time to take additional notes, not to allow
                    you to minimize effort. Mathematical topics are difficult to teach via slides, so often
                    specific topics will be demonstrated or derived on the board, requiring notetaking.
                    This is a contrast with programming topics which often work better via slides. Those
                    with a computer science background may need to relearn note taking habits.
                </p>

                <h3 className="text-xl font-semibold text-blue-600 mb-2">COURSE STRUCTURE/COURSE FORMAT/COURSE
                    OBJECTIVES:</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 px-8">
                    <li>The course combines lectures, hands-on lab projects (individual and group),
                        and active learning activities.
                    </li>
                    <li>Understand the fundamentals of distributed systems and scalable data
                        processing.
                    </li>
                    <li>Gain proficiency in big data technologies and cloud-based data engineering
                        solutions.
                    </li>
                    <li>Develop skills in designing, implementing, and managing large-scale data
                        pipelines.
                    </li>
                    <li>Learn best practices in data governance, integrity, and ethical considerations.
                    </li>
                    <li>Active learning, including peer-based and project-based activities, will
                        constitute a significant portion of class time, emphasizing attendance and
                        participation.
                    </li>
                </ul>
